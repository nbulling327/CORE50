...
<form action = "postjob.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-xs-6">
            ...
            <div id="scrollable-dropdown-menu" class="col-xs-offset-3 col-xs-5">
                Job:
                <div class="row">
                    <div class="col-xs-12">
        ...
        <div id="job_date" class="col-xs-3 col-xs-offset-3">
...
<?php 
                            foreach ($supervisors as $supervisor) 
                            {
                                ...
                                if ($sup_id == $c) {
                                    echo '<option value="' . "$sup_id" . '" selected="selected">' ."$sup_name" . '</option>' ;    
                                }
                                else {
...
<?php 
                            foreach ($pumpers as $pumper) 
                            {
                                ...
                                $pump_id=$pumper["id"];
                                if ($pump_id == $d) {
                                    echo '<option value="' . "$pump_id" . '" selected="selected">' ."$pump_name" . '</option>' ;    
                                }
                                else {
    ...
    <div class="row">
        <div class="col-xs-6 text-left">
            <div class="col-xs-10 col-xs-offset-1 text-left"> 
                ...
                <div class="row">
                    <div class="col-xs-12 text-left">
                        <input name="calculated_disp" class="form-control" type="text" value=<?php echo $f; ?>>
                        bbl
                    </div>
                </div>
            </div>
