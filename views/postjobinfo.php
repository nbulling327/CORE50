...
<form action = "postjob.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-xs-6">
            ...
            <div id="post_well_supervisor" class="col-xs-3 col-xs-offset-2 text-left">
    ...
    <div class="row">
        <div class="col-xs-6 text-left">
            <div class="col-xs-10 col-xs-offset-1 text-left"> Enter Calculated Displacement in bbl:
                <div class="row">
    ...
    <div class="row">
        <div class="col-xs-6 text-left">
            ...
            <div class="col-xs-3 col-xs-offset-2 text-left">
